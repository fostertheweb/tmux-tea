...
find_bind="ctrl-f:change-prompt( : )+reload(find /Users/jonathan/Developer/ -type d -maxdepth 4 -name ".git" -prune -exec dirname {} \; | sed -e \"$home_replacer\")+change-preview($dir_preview_cmd {})"
